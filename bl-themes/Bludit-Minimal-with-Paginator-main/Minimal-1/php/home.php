...
<div class="container-fluid mt-2">
    ...
    <div class="btn-group rounded-pill" role="group" aria-label="Basic example">
      ...
      <a class="btn btn-light text-secondary" href="<?php echo Paginator::previousPageUrl() ?>" role="button"><i class="fas fa-arrow-left"></i></a>
      <?php endif ?>
      <?php if (Paginator::showNext()): ?>
      <a class="btn btn-light text-secondary" href="<?php echo Paginator::nextPageUrl() ?>" role="button"><i class="fas fa-arrow-right"></i></a>
      <?php endif ?>
    </div>
    </div>
    <?php endif ?>
